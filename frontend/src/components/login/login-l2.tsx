...
export function LoginL2({ title, subtitle, children, imageSrc }: LoginL2Props) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-4 px-4 sm:px-6 lg:px-8 md:py-4">
      {/* Desktop Layout */}
      ...
      {/* Mobile Layout - Same as L1 - Form rendered only here on mobile */}
      <div className="md:hidden w-full max-w-md space-y-8">
        ...
        <div className="mt-8 md:hidden">{children}</div>
      </div>
    </div>
  )
}
