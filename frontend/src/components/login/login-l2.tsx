...
export function LoginL2({ title, subtitle, children, imageSrc }: LoginL2Props) {
  return (
    <>
      {/* Desktop Layout */}
      <div className="hidden md:block min-h-screen flex items-center justify-center bg-gray-50 py-4 px-4 sm:px-6 lg:px-8">
      ...
      {/* Mobile Layout - Same as L1 (render only once) */}
      <div className="md:hidden min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
