  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-6xl space-y-8">
        <div className="flex justify-between items-center text-[13px] text-gray-600 md:justify-end">
          <div className="flex items-center gap-2 md:flex-row-reverse md:text-right">
            <button
              type="button"
